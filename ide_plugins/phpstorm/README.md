# CodeRAG PhpStorm Plugin

PhpStorm plugin for CodeRAG code analysis and refactoring.
...
2. Install from disk in PhpStorm: Settings → Plugins → Install Plugin from Disk
3. Select the generated JAR file in `build/distributions/`
...
```
src/main/kotlin/com/coderag/ide/
├── actions/          # IDE actions (menu items, shortcuts)
├── services/         # Application and project services
├── settings/         # Settings management
└── ui/              # UI components (tool window, inlays)
```

### Key Components

- **CodeRAGService**: Application-level service managing API client
- **CodeRAGProjectService**: Project-level service for project state
- **CodeRAGToolWindow**: Tool window for displaying analysis
- **Actions**: Menu actions for user interactions
